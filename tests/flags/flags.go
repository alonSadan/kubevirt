...
func init() {
	...
	flag.StringVar(&IPV4ConnectivityCheckAddress, "conn-check-ipv4-address", "", "Address that is used for testing IPV4 connectivity. If the address is not provided the test will be skipped")
	flag.StringVar(&IPV6ConnectivityCheckAddress, "conn-check-ipv6-address", "", "Address that is used for testing IPV4 connectivity. If the address is not provided the test will be skipped")
	flag.StringVar(&ConnectivityCheckDNS, "conn-check-dns", "", "dns that is used for testing connectivity. If the dns is not provided the test will be skipped")
